 ...
 <!doctype html>
<head>
    <title>Classic Suite from 30,000 at Morning side suitesdsd</title>
    <meta charset="utf-8">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse navbar-light" id="navbarsExample05">
            <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
              <li class="nav-item">
                <a class="nav-link active" href="http://localhost/hotel/1/index.php" style="color:#f4e181">Home</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="rooms-categories">
                  <a class="dropdown-item" href="http://localhost/hotel/../index.php" style="color:#f4e181;">All Rooms</a>
                  <a class="dropdown-item" href="http://localhost/hotel/../presidential-suite/index.php" style="color:#f4e181;">Presidential Suite</a>
                  <a class="dropdown-item" href="http://localhost/hotel/../business-suite/index.php" style="color:#f4e181;">Business Suite</a>
                  <a class="dropdown-item" href="http://localhost/hotel/../classic-suite/index.php" style="color:#f4e181;">Classic Room</a>
                  
                </div>
              </li>
              <li class="nav-item">

                <a class="nav-link " href="http://localhost/hotel/1/facilities/index.php" style="color:#f4e181" >Facilities</a>
              </li>
              <li class="nav-item">
                <a class="nav-link " href="http://localhost/hotel/1/gallery/index.php" style="color:#f4e181;">Gallery</a>
              </li>
              <li class="nav-item">
                <a class="nav-link " href="http://localhost/hotel/1/ contact-us/index.php" style="color:#f4e181;">Contact</a>
              </li>
      ...
      <div class="container">
        ...
        <div class="col-md-5 mb-4">
            ...
            <span class="pricing-from clearfix">
                    <h4 class='float-right ' style="color: #c9ac87"><del>N</del>80,000</h4>
                  </span>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4" style="margin-bottom: 10px;">
            ...
            <div class="post-entry mh-100 d-inline-block p-2" style="background-color: #fff";>
              <a href="../business-suite/index.php"><img src="../../images/classic2.jpg" alt="Classic not just by name. Our classic rooms boast of a wide array of truly first class quality. The interior is just superb, leaving our guests in awe as to what is on offer. The colors, wall decorations and paintings reflect great works of art. There is the presence of a sitting area next to a king size bed in the fully air-conditioned classic room. The classic rooms come with an intercom which means our guests are one dial away from their requests been met. Our guests also have access to high speed internet and other hotel facilities including but not limited to the swimming pool, lounge, and the likes. For every night spend in our classic room, a complimentary breakfast is guaranteed. This is simply putting you first!" title="Classic Suite"></a>
              <div class="body-text" style="height: 100px; padding: 0px;">
          ...
          <div class="row mb-5">
            <div class="col-md-6">
              <div class="widget widget-address">
                                  ...
                                  <div>
                                      <p>Reservations:<br /><i class="fa fa-phone" aria-hidden="true"></i> <a href="tel:+234.0706-815-1023">&nbsp; 09083483484984</a></p>
                                  </div> 
            ...
            <div class="col-md-4">
              ...
              <p>
                ...
                <a href="<br />
<b>Notice</b>:  Undefined index: linkedin in <b>/hotel/includes/footer.php</b> on line <b>26</b><br />
