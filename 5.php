...
<head>
  ...
  "@type": "Product",
  "name": "<?php echo room(1)[1][3] ?>",
  "image":"images/<?php echo room(1)[7][3][1] ?>",
  "description": "<?php echo room(1)[4][3] ?>",
  "sku": "0446310786",
  "mpn": "925872",
  "brand": {
    "@type": "Thing",
  ...
  <body>
    ...
    <section class="site-hero site-hero-innerpage overlay" data-stellar-background-ratio="0.5" style="background-image: url(images/<?php echo settings(1)['main_img']; ?>);">
      ...
      itemtype="https://schema.org/ListItem"><a class='breadcrumb_icon'  href="room2.html" itemtype="https://schema.org/Thing"
       itemprop="item">&<span itemprop="name">&nbsp;<?php echo room(1)[1][3] ?></span></a>
        ...
        <div class="row">
          <div class="col-md-12 text-center" style="padding:10px; ">
            ...
            <div class="mb-3 element-animate">
              <span class="h1">Our <?php echo room(1)[1][3] ?></span>
              ...
              <div id="demo" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner" style="border-radius: 10px">
                    <div class="carousel-item active">
                      <img class='center_room_image' src="images/<?php echo room(1)[7][3][3]?>" alt="<?php echo room(1)[4][3]  ?>" title="<?php echo room(1)[1][3] ?>">
                    </div>
                     <?php for ($i = 1; $i <$a ; $i++) {
                         echo '<div class="carousel-item"> '?>
                      <img class='center_room_image' src="images/<?php echo room(1)[7][3][$i]  ?>" alt="<?php echo room(1)[4][3]  ?>" title="<?php echo room(1)[1][3]  ?>">
                    <?php echo '</div>'?>
        ...
        <div class="row">
          ...
          <div class="col-md-4" style="margin-bottom: 10px;">
            ...
            <div class="post-entry mh-100 d-inline-block p-2" style="background-color: #fff";>
              <a href="1/hotel-rooms/<?php echo strtolower(str_replace(" ","-", room(1)[1][1]))  ?>/index.php"><img src="images/<?php echo room(1)[7][1][3]; ?>" alt="<?php echo room(1)[4][1]  ?>" title="<?php echo room(1)[1][1]  ?>"></a>
          ...
          <div class="col-md-4" style="margin-bottom: 10px;">
            ...
            <div class="post-entry mh-100 d-inline-block p-2" style="background-color: #fff";>
              <a href="1/hotel-rooms/<?php echo strtolower(str_replace(" ","-", room(1)[1][2]))  ?>/index.php"><img src="images/<?php echo room(1)[7][2][3]; ?>" alt="<?php echo room(1)[4][2]  ?>" title="<?php echo room(1)[1][2]  ?>"></a>
              <div class="body-text" style="height: 100px; padding: 0px;">
...
<?php
  ...
  $subdir=strtolower(str_replace(" ","-", room(1)[1][3]));
