    ...
    <html lang="en">
      <head>
        <title>Morning side suitesdsd has a rich list of facilities & guest services offered.</title>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        
        <meta name="description" content="Here is an overview of minimum facilities found in the hotel followed by a list of our La Tavena Latin Restaurant,Italian Restaurant,Swimming Pool,Our Restaurant,Ruthy Savour Signature,Our conference hall,.... ">
          ...
          <div class="collapse navbar-collapse navbar-light" id="navbarsExample05">
            <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
              ...
              <li class="nav-item">
                ...
                <a class="nav-link " href="../facilities/index.php" style="color:#f4e181;color: #fff; font-weight: bold" >Facilities</a>
              </li>
              <li class="nav-item">
